...
class PoseVisualizer {
    ...
    func render(poses: [Pose], on frame: CGImage) -> CGImage? {
        ...
        let dstImage = renderer.image { rendererContext in
            ...
            for pose in poses {
                ...
                for segment in PoseVisualizer.jointSegments {
